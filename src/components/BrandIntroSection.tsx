  ...
  return (
    <section className="noise-texture relative py-10 md:py-14 overflow-hidden">
      <div className="container px-6 md:px-8 relative z-10">
        {/* Text block */}
        <motion.div
          className="flex flex-col items-center text-center max-w-2xl mx-auto mb-8 md:mb-10"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-60px" }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
        >
          <span className="badge-gold mb-3">Miért Minket?</span>
        ...
        {/* 3 highlight cards */}
        <div className="grid grid-cols-3 gap-3 md:gap-5 max-w-2xl mx-auto mb-8 md:mb-10">
          {highlights.map((item, i) => (
            <motion.div
              ...
              className="card-luxury flex flex-col items-center text-center p-4 md:p-5"
            >
